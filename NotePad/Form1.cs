...
namespace NotePad
{
    public partial class Form1 : Form
    {
        ...
        {
            var baco = new ColorDialog();
            var result = baco.ShowDialog();
            if(result == DialogResult.OK)
            {
                richTextBox1.BackColor = baco.Color; 
            }
        }

        private void button13_Click(object sender, EventArgs e)
        {
            var frco = new ColorDialog();
            var result = frco.ShowDialog();
            if (result == DialogResult.OK)
            {
                richTextBox1.ForeColor = frco.Color;
            }
        }
